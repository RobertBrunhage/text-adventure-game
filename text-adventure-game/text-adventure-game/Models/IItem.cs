...
namespace text_adventure_game.Models
{
    interface IItem
    {
        //Using this so that the Item Class must have these properties or else we get an error early on.
        ...
        int EquippedSlotID { get; set; }     //Determines what "slot" the weapon and different armour peices should have
        string BaseType { get; set; }        //A string of either weapon or armour. Simplifies for user when grouping items with categories
